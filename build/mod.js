...
class MetaDemoModBuilding extends ModMetaBuilding {
    constructor() {
    ...
    setupEntityComponents(entity) {
        ...
        entity.addComponent(
            new shapez.ItemProcessorComponent({
                inputsPerCharge: 1,
                processorType: shapez.enumItemProcessorTypes.terminal,
            })
        );
    }
    ...
    getAdditionalStatistics(root, variant) {
        const speed = root.hubGoals.getProcessorBaseSpeed(shapez.enumItemProcessorTypes.terminal);
...
const importTranslations = Object({});
...
const METADATA = Object({"name":"zygzag-test","description":"mod_descripiton","website":"undefined","id":"zygzag-test","version":"0.0.1","author":"ZygZagGaming"});
window.$shapez_registerMod(TestMod, METADATA);
...
module.exports = __webpack_require__(/*! C:\Users\zygza\shapez-mod-test\zygzag-test\src\js\main.js */"./src/js/main.js");
